...
// 다음 순열
// 내림차순
// 1. 뒤에서부터 탐색하며 arr[i]보다 더 작은 arr[i - 1]의 값을 찾는다.
// 2. i - 1보다 더 큰 인덱스중 arr[i - 1]보다 더 큰 값중 가장 작은 값과 swap한다.
// 3. i부터 arr.length - 1까지 순열들을 뒤집어 준다.(i부터 오름차순으로 정렬하기 위함)
public class Main {
