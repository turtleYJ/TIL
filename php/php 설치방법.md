...
1. Choose the PHP version – this example uses 7.4
> brew install shivammathur/php/php@7.4

2. Link the PHP Version
> brew link --overwrite --force php@7.4

3. restart the Terminal

Apache & PHP 버전 확인 명령어
- Apache 확인 : httpd -v
- PHP 확인 : php -v
...
DocumentRoot "/Users/tutleJ/dcRoot"
<Directory "/Users/tutleJ/dcRoot">
```
- loadModule 추가
```
...
LoadModule php7_module /usr/local/Cellar/php@7.4/7.4.30_1/lib/httpd/modules/libphp7.so
